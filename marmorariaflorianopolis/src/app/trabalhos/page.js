...
export default function Home() {
    ...
    <div className="trab-c">
<div className="logos-trab">


<div className="trab-c1">
...
<h1 className="texto-trab1">BANHEIROS</h1>
<div className="trab-c2">
<img src="Constante.jpg" className="constante-prc"></img>
<img src="Constante.jpg" className="constante-prc"></img>
<img src="Constante.jpg" className="constante-prc"></img>
<img src="Constante.jpg" className="constante-prc"></img>
...
<h1 className="texto-trab2">COZINHAS</h1>
<div className="trab-c2">
<img src="Constante.jpg" className="constante-prc"></img>
<img src="Constante.jpg" className="constante-prc"></img>
<img src="Constante.jpg" className="constante-prc"></img>
...
<h1 className="texto-trab3">MESAS</h1>
<div className="trab-c2">
<img src="Constante.jpg" className="constante-prc"></img>
<img src="Constante.jpg" className="constante-prc"></img>
<img src="Constante.jpg" className="constante-prc"></img>
...
<h1 className="texto-trab4">FAIXADAS</h1>
<div className="trab-c8">
<img src="Constante.jpg" className="constante-prc"></img>
<img src="Constante.jpg" className="constante-prc"></img>
<img src="Constante.jpg" className="constante-prc"></img>
<img src="Constante.jpg" className="constante-prc"></img>
...
<h1 className="texto-trab5">SOLEIRAS</h1>
</div>
</div>
